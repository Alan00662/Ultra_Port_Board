...
/* 
    W25Q128JV有256块，每块有16个扇区，每个扇区Sector有16页，每页有128字节，共计16MB
*/


/* QSPI引脚和时钟相关配置宏定义 */

#define QSPI_CS_GPIO_CLK_ENABLE()       __HAL_RCC_GPIOC_CLK_ENABLE()//注意修改启动的时钟源
#define QSPI_CLK_GPIO_CLK_ENABLE()      __HAL_RCC_GPIOB_CLK_ENABLE()//注意修改启动的时钟源
#define QSPI_BK1_D0_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOE_CLK_ENABLE()//注意修改启动的时钟源
#define QSPI_BK1_D1_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOE_CLK_ENABLE()//注意修改启动的时钟源
#define QSPI_BK1_D2_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOE_CLK_ENABLE()//注意修改启动的时钟源
#define QSPI_BK1_D3_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOE_CLK_ENABLE()//注意修改启动的时钟源

#define QSPI_FORCE_RESET()              __HAL_RCC_QSPI_FORCE_RESET()
#define QSPI_RELEASE_RESET()            __HAL_RCC_QSPI_RELEASE_RESET()

#define QSPI_CS_PIN                     GPIO_PIN_11 //QSPI_CS
...
#define QSPI_BK1_D0_PIN                 GPIO_PIN_7 //QSPI_BK1_D0
#define QSPI_BK1_D0_GPIO_PORT           GPIOE
#define QSPI_BK1_D0_GPIO_AF             GPIO_AF10_QUADSPI//有坑，自行比较CubeMX生成的正确指向

#define QSPI_BK1_D1_PIN                 GPIO_PIN_8 //QSPI_BK1_D1
#define QSPI_BK1_D1_GPIO_PORT           GPIOE
#define QSPI_BK1_D1_GPIO_AF             GPIO_AF10_QUADSPI//有坑，自行比较CubeMX生成的正确指向

#define QSPI_BK1_D2_PIN                 GPIO_PIN_9 //QSPI_BK1_D2
#define QSPI_BK1_D2_GPIO_PORT           GPIOE
#define QSPI_BK1_D2_GPIO_AF             GPIO_AF10_QUADSPI//有坑，自行比较CubeMX生成的正确指向

#define QSPI_BK1_D3_PIN                 GPIO_PIN_10 //QSPI_BK1_D3
#define QSPI_BK1_D3_GPIO_PORT           GPIOE
#define QSPI_BK1_D3_GPIO_AF             GPIO_AF10_QUADSPI//有坑，自行比较CubeMX生成的正确指向
...
//在H750XBH6_QSPI_W25Q128_TEST文件与H750XBH6_QSPI_W25Q128_USE文件，上述代码都是直接HAL库生成
//但是在下载算法中不可以这样！！
